...
<br>    
    ...
    ?>
        <div class="comentarios-div">
            ...
            <p class="" style="position: relative;"><?php echo $row3['comentario'] ?><a onclick="return ConfirmaBorrarComentario()" href="../controllersCobrador/borrarComentario.php?id=<?php echo $row3['id'] ?>&idCredito=<?php echo $id ?>&idCobrador=<?php echo $idCobrador ?>"><i class="fas fa-trash-alt" style="position:absolute; right:8px; top:5px; font-size:20px;color:black"></i></a></p>    
        </div>
    ...
    <form method="POST" class="new-comentarios" action="../controllersCobrador/agregarComentario.php">
